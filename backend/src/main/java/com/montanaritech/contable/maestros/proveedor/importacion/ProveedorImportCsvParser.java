...
/**
 * Lee CSV de importación de proveedores (F10.2): misma disposición de
 * columnas que {@link ProveedorImportExcelParser} (fila 0 encabezado, 2 columnas fijas).
 */
@Component
public class ProveedorImportCsvParser implements ProveedorImportParser {
    ...
    public List<ProveedorImportFilaCruda> parsear(InputStream in) throws IOException {
        ...
        try (CSVReader reader = new CSVReaderBuilder(new InputStreamReader(in, StandardCharsets.UTF_8))
            ...
            while ((linea = reader.readNext()) != null) {
                ...
                filas.add(new ProveedorImportFilaCruda(numeroFila, v[0], v[1]));
            }
