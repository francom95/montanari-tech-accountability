...
/**
 * Lee CSV de importación de comisiones (F10.2): misma disposición de
 * columnas que {@link ComisionProyectoImportExcelParser} (fila 0 encabezado, 5 columnas fijas).
 */
@Component
public class ComisionProyectoImportCsvParser implements ComisionProyectoImportParser {
    ...
    public List<ComisionProyectoImportFilaCruda> parsear(InputStream in) throws IOException {
        ...
        try (CSVReader reader = new CSVReaderBuilder(new InputStreamReader(in, StandardCharsets.UTF_8))
            ...
            while ((linea = reader.readNext()) != null) {
                ...
                filas.add(new ComisionProyectoImportFilaCruda(numeroFila, v[0], v[1], v[2], v[3], v[4]));
            }
