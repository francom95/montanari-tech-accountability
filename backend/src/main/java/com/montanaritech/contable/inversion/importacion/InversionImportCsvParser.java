...
/**
 * Lee CSV de importación de inversiones (F10.2): misma disposición de
 * columnas que {@link InversionImportExcelParser} (fila 0 encabezado, 7 columnas fijas).
 */
@Component
public class InversionImportCsvParser implements InversionImportParser {
    ...
    public List<InversionImportFilaCruda> parsear(InputStream in) throws IOException {
        ...
        try (CSVReader reader = new CSVReaderBuilder(new InputStreamReader(in, StandardCharsets.UTF_8))
            ...
            while ((linea = reader.readNext()) != null) {
                ...
                filas.add(new InversionImportFilaCruda(numeroFila, v[0], v[1], v[2], v[3], v[4], v[5], v[6]));
            }
