...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Habilita el CorsConfigurationSource de CorsConfig — sin esto, el
                // navegador bloquea el preflight de /api/** cuando el frontend corre
                // en un origen distinto (siempre en dev; en prod solo si no se sirve
                // detrás del mismo dominio que nginx).
