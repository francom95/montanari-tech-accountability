...
/**
 * Lee CSV del extracto de la sección 1 de "Presupuesto de Pagos" (F10.2):
 * misma disposición de columnas que {@link CompromisoImportExcelParser}
 * (fila 0 encabezado, 3 columnas fijas).
 */
@Component
public class CompromisoImportCsvParser implements CompromisoImportParser {
    ...
    public List<CompromisoImportFilaCruda> parsear(InputStream in) throws IOException {
        ...
        try (CSVReader reader = new CSVReaderBuilder(new InputStreamReader(in, StandardCharsets.UTF_8))
            ...
            while ((linea = reader.readNext()) != null) {
                ...
                filas.add(new CompromisoImportFilaCruda(numeroFila, v[0], v[1], v[2]));
            }
