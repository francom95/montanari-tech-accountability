...
## Corpus Check
- 15 files · ~343,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9621 nodes · 19784 edges · 790 communities (481 shown, 309 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 1215 edges (avg confidence: 0.8)
...
## Communities (790 total, 309 thin omitted)

### Community 0 - "Cliente CRUD"
Cohesion: 0.06
Nodes (53): FacturaCompraController, DeleteMapping, EstadoDocumento, FacturaCompraCrearRequest, FacturaCompraEditarRequest, FacturaCompraMapper, GetMapping, Page (+45 more)
...
Cohesion: 0.05
Nodes (48): CalculoIva, ComponenteCalculado, DetalleImputacion, TipoComponenteIva, CalculoIvaService, RequiredArgsConstructor, Service, TipoComponenteIva (+40 more)
...
Cohesion: 0.07
Nodes (37): Auditado, AuditoriaService, Cliente, ClienteRepository, ComisionProyectoService, CuotaRequest, EtapaRepository, Moneda (+29 more)

### Community 12 - "Manejo de errores y seguridad"
Cohesion: 0.08
Nodes (31): AsientoRepository, Auditado, AuditoriaService, CuentaContable, CuentaContableRepository, EstadoVencimientoObligacion, Moneda, MonedaRepository (+23 more)
...
Cohesion: 0.08
Nodes (24): ClienteMapper, Cliente, Mapper, Mapping, ClienteService, Auditado, AuditoriaService, Cliente (+16 more)

### Community 19 - "CuentaBancaria mapper/service"
Cohesion: 0.10
Nodes (19): AsientoEditarConfirmadoRequest, AsientoEditarRequest, AsientoGenerado, AsientoLinea, AsientoLineaEditarRequest, AuditoriaService, AsientoService, Asiento (+11 more)

### Community 20 - "Moneda CRUD"
Cohesion: 0.08
Nodes (31): CrearMovimientoBancarioRequest, OrigenImportacionMovimiento, Asiento, CuentaBancaria, CuentaContable, Entity, EstadoMovimientoBancario, FuenteTc (+23 more)
...
Cohesion: 0.09
Nodes (21): TipoLiquidacion, TipoRecurrencia, TipoVencimiento, VencimientoResponse, EstadoVencimientoObligacion, CancelarRequest, GenerarAutomaticosResponse, Page (+13 more)
...
Cohesion: 0.08
Nodes (24): PrioridadPendiente, PendienteAdministrativoCrearRequest, EstadoPendiente, PrioridadPendiente, PendienteAdministrativoEditarRequest, EstadoPendiente, PrioridadPendiente, PendienteAdministrativoResponse (+16 more)

### Community 29 - "TarjetaCredito CRUD (tests)"
Cohesion: 0.08
Nodes (25): Component, Override, PagoTarjeta, PagoTarjetaAsientoGenerator, AsientoGenerator, LineaAsientoGenerada, Component, ConceptoContable (+17 more)
...
Cohesion: 0.09
Nodes (17): CompromisoCrearRequest, TipoCompromiso, EstadoCompromiso, TipoCompromiso, OrigenGeneracionVencimiento, CompromisoServiceTest, AuditoriaService, Compromiso (+9 more)
...
Cohesion: 0.06
Nodes (26): CobroCrearRequest, CobroEditarRequest, CobroImputacionRequest, CobroTributoRequest, TipoTributo, FacturaCompraCrearRequest, TipoComprobante, FacturaCompraEditarRequest (+18 more)
...
Cohesion: 0.10
Nodes (24): AlertaRepository, Alerta, EstadoAlerta, Page, Pageable, Query, TipoAlerta, ConfiguracionAlertasRepository (+16 more)
...
Cohesion: 0.09
Nodes (22): AsociarMovimientoBancarioRequest, ContadorPendientesResponse, CorregirMovimientoBancarioRequest, DescartarMovimientoBancarioRequest, ImputarMovimientoBancarioRequest, MovimientoBancarioResponse, EstadoMovimientoBancario, GetMapping (+14 more)
...
Cohesion: 0.12
Nodes (21): AsientoServiceTest, AfterEach, AsientoLinea, AsientoLineaEditarRequest, AsientoMapper, AuditoriaService, BeforeEach, ClienteRepository (+13 more)

### Community 46 - "Entidad Etapa"
Cohesion: 0.10
Nodes (24): Entity, Getter, LineaEstadoResultados, Rubro, Setter, Table, MapeoRubroLineaEstadoResultados, Mapper (+16 more)
...
Cohesion: 0.11
Nodes (19): EstadoVencimiento, CuentaPorPagarService, Importe, RequiredArgsConstructor, Service, AplicacionAnticipoProveedorRepository, Query, ImputadoFacturaCompra (+11 more)
...
Cohesion: 0.12
Nodes (14): RefreshTokenRepository, TenantRepository, ConfiguracionCobranzaRepository, AtribucionImpuestoRepository, ConfiguracionAtribucionRepository, EtapaRepository, Etapa, Page (+6 more)
...
Cohesion: 0.14
Nodes (7): ExtractorFacturaPdf, Component, ExtractorFacturaPdfTest, Test, CamposExtraidosPdf, Pattern, TipoComprobante
...
Cohesion: 0.13
Nodes (19): PagoTarjetaCrearRequest, Asiento, Entity, EstadoDocumento, Getter, Moneda, Setter, Table (+11 more)
...
Cohesion: 0.15
Nodes (19): AplicacionAnticipoClienteRepository, AplicacionAnticipoProveedorRepository, BeforeEach, Cliente, CobroImputacionRepository, ComisionProyectoRepository, ExtendWith, FacturaCompraRepository (+11 more)
...
Cohesion: 0.18
Nodes (14): DatosAlerta, CompromisoService, ConciliacionService, CuentaBancariaRepository, CuentaPorCobrarService, CuentaPorPagarService, MovimientoBancarioRepository, PendienteAdministrativoService (+6 more)
...
Cohesion: 0.13
Nodes (17): AgregarComponenteRequest, AjustarComponenteRequest, AnularRequest, ComponenteResponse, CrearRequest, EditarJurisdiccionRequest, TipoComponenteIibb, JurisdiccionPrevisualizadaResponse (+9 more)
...
Cohesion: 0.21
Nodes (13): AsientoMapper, BusquedaGlobalController, RequiredArgsConstructor, AsientoAperturaController, RequiredArgsConstructor, ImportacionFacturaHistoricaController, FilaImportacionResultadoResponse, RequiredArgsConstructor (+5 more)

### Community 168 - "Override"
Cohesion: 0.20
Nodes (13): ConfiguracionAlertasController, ConfiguracionAlertas, GetMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, RestController, Tag (+5 more)
...
Cohesion: 0.24
Nodes (6): ImportacionFacturaHistoricaServiceTest, BeforeEach, BuscarAsientoPorComprobante, FilaImportacionConfirmarRequest, FilaImportacionPreviewResponse, Test

### Community 173 - "Setter"
Cohesion: 0.15
Nodes (14): CuentaContable, Entity, Getter, Setter, Table, TipoComponenteIibb, LiquidacionIibbComponente, ComponenteResponse (+6 more)
...
Cohesion: 0.20
Nodes (13): ConfiguracionPresupuestoController, ConfiguracionPresupuesto, GetMapping, PreAuthorize, PutMapping, RequestMapping, RequiredArgsConstructor, Response (+5 more)
...
Cohesion: 0.19
Nodes (11): CalculoIibb, JurisdiccionCalculada, CalculoIibbService, RequiredArgsConstructor, Service, Transactional, Jurisdiccion, Page (+3 more)
...
Cohesion: 0.17
Nodes (12): ComisionProyectoImportController, MultipartFile, PostMapping, PreAuthorize, RequestMapping, RequiredArgsConstructor, RestController, Tag (+4 more)
...
Cohesion: 0.22
Nodes (12): ComisionProyectoRepository, Page, Pageable, Query, ComisionProyectoImportService, ComisionProyectoMapper, ComisionProyectoService, MultipartFile (+4 more)
...
### Community 209 - "Plan"
Cohesion: 0.17
Nodes (11): CuentaPorCobrarService, Importe, EstadoVencimiento, RequiredArgsConstructor, Service, Transactional, CuentaPorCobrarFilaResponse, CuentaPorCobrarResponse (+3 more)
...
Cohesion: 0.15
Nodes (10): TipoLiquidacion, TipoRecurrencia, TipoVencimiento, VencimientoCrearRequest, TipoLiquidacion, TipoRecurrencia, TipoVencimiento, VencimientoEditarRequest (+2 more)
...
Cohesion: 0.30
Nodes (9): CuentaPorCobrarController, EstadoVencimiento, GetMapping, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController, StreamingResponseBody (+1 more)
...
Cohesion: 0.20
Nodes (7): FacturaVentaAsientoGenerator, Component, FacturaVenta, Override, RequiredArgsConstructor, CodigoComprobanteAfip, TipoComprobante
...
Cohesion: 0.24
Nodes (4): ComisionProyectoImportCsvParser, Component, Override, ComisionProyectoImportParser
...
Cohesion: 0.33
Nodes (8): Alerta, Entity, EstadoAlerta, Getter, Setter, SeveridadAlerta, Table, TipoAlerta
...
Cohesion: 0.39
Nodes (5): ComisionProyectoImportExcelParser, Component, DataFormatter, Override, Row
...
Cohesion: 0.38
Nodes (5): PresupuestoCalculado, PresupuestoProyecto, Response, PresupuestoProyectoMapper, Component
...
## Knowledge Gaps
- **902 isolated node(s):** `🔴 Hallazgo urgente (no relacionado con el mapeo)`, `Cómo se decodifican los códigos corrompidos (aplica a "Plan de Cuentas" y "Libro Diario")`, `Orden de importación por dependencias (F10.2)`, `1. `Clientes` → **Cliente + Proyecto + ProyectoCuota** — migra como dato definitivo`, `2. `Base de datos - Clientes` → **Cliente** (complementa a la hoja anterior) — migra como dato definitivo` (+897 more)
...
- **Why does `MonedaRepository` connect `Doc de salida F2.6: presupuesto por proyecto` to `Autenticacion y usuarios`, `proveedor.ts`, `http.ts`, `InversionService (F8.4)`, `Service`, `Motor de asientos (AsientoGenerator)`, `Getter`, `DTOs PendienteAdministrativo (F8.5)`, `Proveedor CRUD/logic`, `Moneda CRUD (excepciones)`, `Verificación de balanceo global (Σ debe `, `TarjetaCreditoMapper`, `Proveedor CRUD (excepciones)`, `FlujoCajaController y DTOs (F8.3)`, `Test`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `ProyectoRepository` connect `PresupuestoProyectoMapper` to `require-admin.tsx`, `TipoCosto CRUD`, `utils.ts`, `dashboard-page.tsx`, `Jurisdiccion CRUD`, `Proveedor CRUD (DTOs)`, `RefreshTokenService`, `Montanari Tech — Sistema de Gestión Contable`, `Qué se hizo`, `Importación de etapas (Excel/CSV con pre`, `Estilos corporativos centralizados en ex`, `Bancos Tarjetacredito Consumotarjeta`, `CuentaBancaria CRUD/logic`, `Impuestos Iva Liquidacionivacomponente`, `use-concepto.ts`, `DTOs PendienteAdministrativo (F8.5)`, `use-tipocosto.ts`, `Auth Usuariocontroller`, `Use Liquidacion Iibb`, `tarjetas-credito-page.tsx`, `App.tsx`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `VencimientoService` connect `Manejo de errores y seguridad` to `Docs del plan (cluster)`, `TipoCosto CRUD`, `Moneda CRUD/logic`, `cliente.ts`, `use-balance-sumas-y-saldos.ts`, `Verificación de balanceo global (Σ debe `, `Exportacion de reportes (Excel/PDF)`, `Multimoneda y diferencia de cambio`, `Categoria CRUD/logic`?**
